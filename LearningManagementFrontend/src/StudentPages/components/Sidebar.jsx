...
export default function Sidebar({ activePage, setPage }) {
  // Quản lý trạng thái mở/đóng của tất cả các menu
    ...
    <aside className="sidebar">
      ...
      <div className="sidebar-section">
        ...
        <div className={`sub-menu ${open.khac ? 'open' : ''}`}>
          <div className={cls('doi-mk')} onClick={() => setPage('doi-mk')}>Đổi mật khẩu</div>
          <div className={cls('hop-thu-sv')} onClick={() => setPage('hop-thu-sv')}>Hộp thư sinh viên</div>
        </div>
      </div>
    </aside>
  );
