...
INSERT IGNORE INTO courses (id, department_id, code, name, credits, theory_sessions, practical_sessions, total_sessions) VALUES
(21, 6, 'CO1027', 'Kỹ thuật lập trình', 3, 30, 15, 45),
(22, 6, 'CO2013', 'Cơ sở dữ liệu', 4, 45, 15, 60),
(23, 21, 'EE1001', 'Mạch điện tử', 3, 30, 15, 45),
(24, 22, 'CE2001', 'Cơ học kết cấu', 3, 45, 0, 45);

-- Thêm Users cho Bách Khoa (Giảng viên)
INSERT IGNORE INTO users (id, school_id, code, citizen_id_number, email, full_name, gender, date_of_birth, is_active) VALUES
(30, 2, 'GV201', '079099000201', 'gv201@hcmut.edu.vn', 'Phạm Trí Tuệ', 'MALE', '1980-01-01', 1),
(31, 2, 'GV202', '079099000202', 'gv202@hcmut.edu.vn', 'Nguyễn Thuật Toán', 'MALE', '1985-02-02', 1),
(32, 2, 'GV203', '079099000203', 'gv203@hcmut.edu.vn', 'Trần Mạch Điện', 'FEMALE', '1990-03-03', 1);
...
INSERT IGNORE INTO users (id, school_id, code, citizen_id_number, email, full_name, gender, date_of_birth, is_active) VALUES
(40, 2, '2210001', '079099000401', '2210001@hcmut.edu.vn', 'Lê Bách Khoa', 'MALE', '2004-01-01', 1),
(41, 2, '2210002', '079099000402', '2210002@hcmut.edu.vn', 'Nguyễn Cơ Khí', 'MALE', '2004-02-02', 1),
(42, 2, '2210003', '079099000403', '2210003@hcmut.edu.vn', 'Trần Xây Dựng', 'FEMALE', '2004-03-03', 1),
(43, 2, '2210004', '079099000404', '2210004@hcmut.edu.vn', 'Phạm Điện Tử', 'MALE', '2004-04-04', 1),
(44, 2, '2210005', '079099000405', '2210005@hcmut.edu.vn', 'Đinh Chưa Phân Bổ 1', 'MALE', '2004-05-05', 1),
(45, 2, '2210006', '079099000406', '2210006@hcmut.edu.vn', 'Hoàng Chưa Phân Bổ 2', 'FEMALE', '2004-06-06', 1);
...
-- Thêm Lớp học
INSERT IGNORE INTO classes (id, code, course_id, semester_id, max_students, status) VALUES
(21, 'CO1027-L01', 21, 1, 40, 'OPEN'),
(22, 'CO2013-L01', 22, 1, 40, 'OPEN');
