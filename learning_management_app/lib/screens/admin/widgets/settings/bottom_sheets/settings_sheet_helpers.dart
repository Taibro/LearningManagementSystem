  ...
  return Padding(
    ...
    child: Row(children: [
      Container(
          ...
          height: 40,
          decoration: BoxDecoration(
              color: kPrimary.withOpacity(0.10), shape: BoxShape.circle),
...
Widget buildSheetField(String label, String value) =>
      ...
      Container(
        ...
        child: Text(
          ...
          style: TextStyle(
              fontSize: 13,
              color:
                  value.isEmpty ? const Color(0xFFBDBDBD) : const Color(0xFF212121)),
        ),
      ),
    ]);

Widget buildSheetSubmitButton(String label, VoidCallback onTap) {
  const kPrimary = Color(0xFF1A237E);
