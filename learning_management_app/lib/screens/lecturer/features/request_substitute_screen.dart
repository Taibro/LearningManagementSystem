...
class RequestSubstituteScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Đề xuất dạy thay', style: TextStyle(fontWeight: FontWeight.bold)),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              _buildTextField('Giảng viên dạy thay (Tên / Mã GV)'),
              const SizedBox(height: 16),
              _buildTextField('Ngày dạy thay'),
              const SizedBox(height: 16),
              _buildTextField('Lý do', maxLines: 3),
